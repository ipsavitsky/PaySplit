...
Most of this code is *heavily* inspired by the excellent [buildspace](https://buildspace.so) courses. However, any bad patterns here are due to me being a React newb, not their fault :)
